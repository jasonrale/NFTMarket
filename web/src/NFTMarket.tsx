...
import nftMarketABI from "./utils/nftMarket.json"

// 请替换成BANK合约地址
const nftMarketAddress = "0x163420Fa9f9A12C34f2728e40D32b6aA0385778e"
...
const Bank = () => {
    ...
    const walletInitstate: WalletState = { signer: null, chainId: "", balance: "" }
    ...
    const handleDeposit = async () => {
        ...
        const tx = await bankContract?.depositETH({ value: amount })
    ...
    const handleWithdraw = async () => {
        ...
        // 执行请求
        const tx = await bankContract?.userWithdraw()
        console.log(tx)
